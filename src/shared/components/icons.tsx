...
export function MapPinIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <path
        d="M12 22s7-6.8 7-12.5A7 7 0 0 0 5 9.5C5 15.2 12 22 12 22Z"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinejoin="round"
      />
...
// --- Added by the `secretary` module (merged from main). ImageIcon, PackageIcon,
// UserXIcon, CalendarXIcon, LogInIcon, GlobeIcon and HistoryIcon are new names with
// no clash. CalendarIcon, BriefcaseIcon, MapPinIcon, InboxIcon and BellIcon already
// existed above under those names (used across HR/admin/placement/faculty) — main's
// versions are kept here under a `Secretary*` prefix instead of overwriting the
// existing ones, so neither side's icon usage changes.
